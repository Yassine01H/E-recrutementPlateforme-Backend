 ...
 */
final class Version20230404082823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job_offer (id INT AUTO_INCREMENT NOT NULL, recruiter_id INT DEFAULT NULL, titlejob VARCHAR(255) NOT NULL, job VARCHAR(255) NOT NULL, expeience VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', salary VARCHAR(255) NOT NULL, contract VARCHAR(255) NOT NULL, salary_min VARCHAR(255) NOT NULL, salary_max VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, currency_position VARCHAR(255) NOT NULL, qualifications VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, full_adress VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_288A3A4E156BE243 (recruiter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
